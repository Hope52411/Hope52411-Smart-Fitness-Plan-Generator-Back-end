...
public class EmailService {
    ...
    public void sendEmail(String toEmail, String resetToken) {
        ...
        String resetLink = "https://hope52411.tech/reset-password?token=" + resetToken;
        ...
        String body = "<div style='font-family: Arial, sans-serif; max-width: 600px; padding: 20px; border: 1px solid #ddd; border-radius: 8px;'>"
                ...
                + "<p><strong>Note:</strong> This link will expire in <strong>30 minutes</strong>. Please complete the process as soon as possible.</p>"
                + "<br>"
